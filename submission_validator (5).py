...
conf = {
    "submission_name": "oominimax",
    "specified_files": ["oominimax/submit.git.log.txt", "oominimax/debugger.png", "oominimax/oominimax.py", "oominimax/README"],
    "assignment_version": "Weekly Exercise 6",
}
